        ...
        private void LoadMenu()
        {
            ...
            var spellMenu = new Menu("SpellMenu", "SpellMenu");
            {
                var qMenu = new Menu("QMenu", "QMenu");
                {
                    ...
                    qMenu.AddItem(new MenuItem("Auto_Q_Slow", "自動 W 移動緩慢目標").SetValue(true));
                    qMenu.AddItem(new MenuItem("Auto_Q_Immobile", "自動 W 不動目標").SetValue(true));
                ...
                {
                    wMenu.AddItem(
                        new MenuItem("W_Max_Range", "使用 W 的最大距離調整").SetValue(new Slider(900, 500, 1050)));
                    spellMenu.AddSubMenu(wMenu);
                }

                var eMenu = new Menu("EMenu", "EMenu");
                {
                    eMenu.AddItem(new MenuItem("E_On_Killable", "使用 E 如果敵人可殺").SetValue(true));
