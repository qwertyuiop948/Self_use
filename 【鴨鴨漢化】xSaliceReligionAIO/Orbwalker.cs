...
namespace xSaliceReligionAIO
{
    ...
    public class xSLxOrbwalker
    {
        ...
        public static void AddToMenu(Menu menu)
        {
            ...
            var menuDrawing = new Menu("範圍", "orb_Draw");
            menuDrawing.AddItem(new MenuItem("orb_Draw_AARange", "平A範圍").SetValue(new Circle(true, Color.FloralWhite)));
            menuDrawing.AddItem(new MenuItem("orb_Draw_AARange_Enemy", "敵人平A範圍").SetValue(new Circle(true, Color.Pink)));
            menuDrawing.AddItem(new MenuItem("orb_Draw_Holdzone", "控制區 (在此區域不會移動)").SetValue(new Circle(true, Color.FloralWhite)));
            menuDrawing.AddItem(new MenuItem("orb_Draw_MinionHPBar", "小兵血格").SetValue(new Circle(true, Color.Black)));
            menuDrawing.AddItem(new MenuItem("orb_Draw_MinionHPBar_thickness", "格子密度").SetValue(new Slider(1, 1, 3)));
            ...
            var menuMelee = new Menu("亂鬥", "orb_Melee");
            menuMelee.AddItem(new MenuItem("orb_Melee_Prediction", "移動預測").SetValue(false));
            menu.AddSubMenu(menuMelee);

            var menuModes = new Menu("走砍模式", "orb_Modes");
            {
                var modeCombo = new Menu("接技", "orb_Modes_Combo");
                ...
                modeHarass.AddItem(new MenuItem("Harass_Lasthit", "尾兵").SetValue(true));
                ...
                var modeLasthit = new Menu("尾兵", "orb_Modes_LastHit");
